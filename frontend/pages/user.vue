    ...
    <div v-else>
      ...
      <v-row>
        <v-col cols="12" sm="12" md="6" lg="6">
          <h2 class="mb-3 text-center">YOUR LIFE IS GAME</h2>
          <h3>
            It's not a big deal!
          </h3>
        </v-col>
      ...
      <v-row class="introduction">
        ...
        <v-col cols="12" sm="12" md="4" lg="4">
          ...
          <h3>With you I'm blessed...</h3>
          <p>
            For the little meaning Ninjas to train on the trees.
          </p>
        </v-col>
        <v-col cols="12" sm="12" md="4" lg="4">
          <v-img width="50%" height="50%"
          ...
          <h3>We can take it real slow</h3>
          <p>
            slow slow slow...
          </p>
        </v-col>
